  ...
  return (
    <div className="bg-black rounded-xl p-4 shadow-md">
      <div className="h-32 md:h-52 relative group">
        ...
        >
          <div className="overlay items-center justify-center absolute top-0 left-0 w-full h-full bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500" style={{ width: "70%" , height: "77%"}}>
            <Link
              href={gitUrl}
